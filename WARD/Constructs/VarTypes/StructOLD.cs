...
namespace WARD.Constructs {
    ...
    // A custom structure.
    public class VarTypeStructOLD : VarType {
        public Scope Scope;
        ...
        public VarTypeStructOLD(Scope scope, Modifier modifier, string name, List<StructEntry> entries, List<VarTypeStruct> implements) {
            Scope = scope;
            Modifier = modifier;
            Name = name;
            Entries = entries;
